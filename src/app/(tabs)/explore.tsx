...
const ExploreScreen = () => {
  ...
  const filterdUsers = !search.trim() ? users : users.filter(
    (user) => user.name?.toLowerCase().includes(search.toLowerCase()) || user.id?.toLowerCase().includes(search.toLowerCase())
  )
